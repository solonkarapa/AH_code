...
#' @param predictors vector of predicted risks of the models to plot
...
#' @param xby stepsize for looking at different threshold probabilities
#' @param ymin minimum of y-axis in the plot
#' @param probablity 
#' @param harm 
#' @param graph TRUE if we want a graph of NB curves to print
#' @param intervention 
